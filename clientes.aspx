<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="clientes.aspx.cs" Inherits="GoWebForms.clientes" %>
        ...
        <main>
            ...
            <section class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <asp:DropDownList ID="searchParameterDDL" runat="server" CssClass="form-control" Font-Size="Small">
                                        <asp:ListItem Text="Razón social" Value="RAZON"></asp:ListItem>

                                        <asp:ListItem Text="RUC" Value="RUC"></asp:ListItem>
                                        <asp:ListItem Text="Representante" Value="REPRESENTANTE"></asp:ListItem>
                                ...
                                <div class="col-6">
                                    <div class="btn-group btn-shadow">
                                        ...
                                        <asp:LinkButton CssClass="btn btn-primary btn-border" runat="server" ID="AddRegistroBtn" data-toggle="modal" data-target="#addModal" ToolTip="Agregar cliente" Font-Size="Small">
                                <div class="form-row">
                                <asp:Label  Text="Agregar cliente" CssClass="btn-label d-none  d-xl-block d-lg-block" runat="server" Font-Size="Small"></asp:Label> 
                                <i class="fas fa-plus fa-sm"  style="padding:5px"></i>
                                        ...
                                        <%-- <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <a class="dropdown-item" href="/Clientes.aspx?PageSize=10" runat="server">10</a>
                                                <a class="dropdown-item" href="/Clientes.aspx?PageSize=20" runat="server">20</a>
                                                <a class="dropdown-item" href="/Clientes.aspx?PageSize=30" runat="server">30</a>
                                                <a class="dropdown-item" href="/Clientes.aspx?PageSize=50" runat="server">50</a>
                                            </div>
                                        </div>--%>
                                    </div>
                                </div>
                ...
                <div class="row pie small" style="padding-left: 15px">
                    <asp:DataPager ID="ClienteDataPager" runat="server" PagedControlID="ClienteListView" PageSize="10">
                        <Fields>
                ...
                <asp:ListView ID="ClienteListView"
                    ...
                    OnItemDataBound="ClienteListView_ItemDataBound"
                    OnItemCommand="ListView_ItemCommand">
                    <LayoutTemplate>
                        <div class="table table-responsive">
                            <table class="table table-sm  table-striped  table-hover   small ">
                                <caption>
                                    <h3><span class="badge">CLIENTES</span></h3>
                                </caption>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblobservaciones" runat="server" Text='<%# Eval("observaciones") %>' /></td>
                            <td>
                                <asp:Label ID="lblfecha_alta" runat="server" Text='<%# Eval("fecha_alta") %>' /></td>

                            <td>
                                <asp:Label ID="lblcodigo" runat="server" Text='<%# Eval("codigo") %>' /></td>
                            <td>
                                <asp:Label ID="lbldireccion_envio" runat="server" Text='<%# Eval("direccion_envio") %>' /></td>
                            <td>
                                <asp:Label ID="lblrepresentante_legal" runat="server" Text='<%# Eval("representante_legal") %>' /></td>



                            <td>
                                <asp:LinkButton runat="server" ID="EditClienteBtn" CommandName="Editar" CommandArgument='<%# Eval("id_cliente")%>' ToolTip="Editar">
                                    <i class="fa fa-keyboard fa-sm"></i>
                                </asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton runat="server" ID="InvoiceClienteBtn" CommandName="Facturas" CommandArgument='<%# Eval("id_cliente")%>' ToolTip="Ver facturas">
                                    <i class="fas fa-file-invoice-dollar"></i>
                                </asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton runat="server" ID="DeleteClienteBtn" CommandName="Eliminar" CommandArgument='<%# Eval("id_cliente")%>' ToolTip="Eliminar" OnClientClick="return confirm('Desea eliminar el registro?');">
                            ...
                            <ContentTemplate>
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <b id="addModalLabel">Agregar un nuevo Cliente.</b>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-body">
                                        <asp:FormView ID="InsertFormView" runat="server" DataSourceID="ClienteDS" Width="100%"
                                            CellPadding="4" DataKeyNames="id_cliente" ForeColor="#333333"
                                            DefaultMode="Insert"
                                            ...
                                            <InsertItemTemplate>
                                                <div class="container-fluid">
                                                        ...
                                                        <div class="col-3">
                                                            RAZÓN SOCIAL
                                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                                  ControlToValidate="txtrazon_social"
                                                                  Display="Static"
                                                                  ErrorMessage="*"
                                                                  runat="server" />
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-9">
                                                            <asp:TextBox ID="txtobservaciones" runat="server" Text='<%# Bind("observaciones") %>' CssClass="form-control" Font-Size="X-Small" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-3">DIR. ENVIO</div>
                                                        <div class="col-9">
                                                            <asp:TextBox ID="txtdireccion_envio" runat="server" Text='<%# Bind("direccion_envio") %>' CssClass="form-control" Font-Size="X-Small" />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-3">REPRESENTANTE</div>
                                                        <div class="col-9">
                                                            <asp:TextBox ID="txtrepresentante_legal" runat="server" Text='<%# Bind("representante_legal") %>' CssClass="form-control" Font-Size="X-Small" />
                                                        </div>
                                                    </div>
                                            ...
                                            <EditItemTemplate>
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-9">
                                                            <asp:TextBox ID="txtid_cliente" runat="server" Text='<%# Bind("id_cliente") %>' CssClass="form-control mitad" Font-Size="X-Small" Enabled="false" />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                ...
                <asp:SqlDataSource ID="ClienteDS"
                    ...
                    InsertCommand="go.sp_ClienteS_insert" InsertCommandType="StoredProcedure"
                    SelectCommand="go.sp_Clientes_get_all" SelectCommandType="StoredProcedure">
                    <DeleteParameters>
                    ...
                    <InsertParameters>
                        ...
                        <asp:Parameter Name="direccion_envio" Type="String" />
        ...
        <script>
            ...
            function buildTable(response) {
                ...
                response.forEach(invoice => {
                    const { id_cliente, razon_social, ruc, fecha_alta, direccion } = invoice;

                    innerBodyHtml = innerBodyHtml + `<tr> <td>${id_cliente}</td> <td>${ruc}</td> <td>${razon_social}</td>     <td type='date'>${fecha_alta}</td> <td>${direccion}</td>   <td><a href="/Proveedores.html?client=${id_cliente}" class="button">Ver proveedores</a></td>  <tr>`;
                });
