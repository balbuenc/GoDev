<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ingresar.aspx.cs" Inherits="GoWebForms.ingresar" %>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 text-center">
                        <h1 class="display-2 mb-3">Iniciar sesión</h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label class="form-label text-dark" for="firstNameLabel">Usuario <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label class="form-label text-dark" for="lastNameLabel">Contraseña <span class="text-danger">*</span></label>
                                                <div class="input-group mb-4">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                                    </div>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="text-center">
                                                <%--<button type="button" class="btn btn-primary mt-4 animate-up-2" onclick="iniciar_go();"><span class="mr-2"><i class="fas fa-paper-plane"></i></span>Ingresar</button>--%>
                                                <asp:Button ID="LoginButton" Text="Ingresar"  OnClick="Login_OnClick" runat="server" CssClass="btn btn-primary mt-4 animate-up-2" />
                                            </div>
                                        </div>
                                        <div class="text-center">
